...
final class DeveloperPreview {
    ...
    let coffeeDetails: [CoffeeDetail] = [
        makeCoffeeDetail(
            ...
            rating: 4.6,
            price: 3.50,
            sizes: makeSizes(["Small", "Medium"], activeIndex: 0),
            modifiers: makeModifiers(["Extra cream", "Sugar", "Double shot"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000002",
            categoryId: categoryLatte,
            ...
            rating: 4.8,
            price: 4.00,
            sizes: makeSizes(["8 oz", "12 oz", "16 oz"], activeIndex: 1),
            modifiers: makeModifiers(["Light milk", "Extra shot", "Sugar"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000003",
            categoryId: categoryLatte,
            ...
            price: 4.20,
            sizes: makeSizes(["8 oz", "12 oz", "16 oz"], activeIndex: 1),
            modifiers: makeModifiers(["Extra chocolate", "Whipped cream", "Sugar"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000004",
            categoryId: categoryLatte,
            ...
            price: 3.80,
            sizes: makeSizes(["8 oz", "12 oz", "16 oz"], activeIndex: 1),
            modifiers: makeModifiers(["Extra chocolate", "Light milk", "Sugar"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000005",
            categoryId: categoryMachiato,
            ...
            rating: 4.9,
            price: 3.90,
            sizes: makeSizes(["Small", "Medium", "Large"], activeIndex: 1),
            modifiers: makeModifiers(["Extra foam", "Cocoa powder", "Sugar"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000006",
            categoryId: categoryAmericano,
            ...
            price: 3.20,
            sizes: makeSizes(["Small", "Medium", "Large"], activeIndex: 1),
            modifiers: makeModifiers(["Extra shot", "Sugar", "Light water"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000007",
            categoryId: categoryAmericano,
            ...
            rating: 4.7,
            price: 2.90,
            sizes: makeSizes(["Single", "Double"], activeIndex: 1),
            modifiers: makeModifiers(["Sugar", "Decaf"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000008",
            categoryId: categoryLatte,
            ...
            rating: 4.6,
            price: 4.50,
            sizes: makeSizes(["12 oz", "16 oz", "20 oz"], activeIndex: 1),
            modifiers: makeModifiers(["Extra caramel", "Light milk", "Sugar"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000009",
            categoryId: categoryLatte,
            ...
            price: 4.30,
            sizes: makeSizes(["12 oz", "16 oz", "20 oz"], activeIndex: 1),
            modifiers: makeModifiers(["Extra vanilla", "Light milk", "Sugar"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000010",
            categoryId: categoryLatte,
        ...
        makeCoffeeDetail(
            ...
            price: 3.40,
            sizes: makeSizes(["Small", "Medium"], activeIndex: 0),
            modifiers: makeModifiers(["Double shot", "Light milk", "Sugar"])
        ),
        makeCoffeeDetail(
            id: "b2000001-0001-4001-8001-000000000012",
            categoryId: categoryMachiato,
